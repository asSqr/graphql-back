...
type ComplexityRoot struct {
	Query struct {
		Recipe func(childComplexity int, id int) int
	}
...
type QueryResolver interface {
	Recipe(ctx context.Context, id int) (*model.Recipe, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.recipe":
		...
		return e.complexity.Query.Recipe(childComplexity, args["id"].(int)), true
...
var sources = []*ast.Source{
	{Name: "graph/schema.graphqls", Input: `# schema.graphql
type Recipe {
  id: Int!
  title: String!
  imageUrl: String
...
func (ec *executionContext) _Query_recipe(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Query().Recipe(rctx, args["id"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNRecipe2ᚖgithubᚗcomᚋasSqrᚋgraphqlᚑbackᚋgraphᚋmodelᚐRecipe(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNRecipe2githubᚗcomᚋasSqrᚋgraphqlᚑbackᚋgraphᚋmodelᚐRecipe(ctx context.Context, sel ast.SelectionSet, v model.Recipe) graphql.Marshaler {
	return ec._Recipe(ctx, sel, &v)
}

func (ec *executionContext) marshalNRecipe2ᚖgithubᚗcomᚋasSqrᚋgraphqlᚑbackᚋgraphᚋmodelᚐRecipe(ctx context.Context, sel ast.SelectionSet, v *model.Recipe) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
